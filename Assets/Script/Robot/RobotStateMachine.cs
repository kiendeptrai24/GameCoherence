...
public class RobotStateMachine : IStateMachine
{
    private Dictionary<Type, IState> _statesDirtionary = new Dictionary<Type, IState>();

    private IState _curState;
    private readonly IStateFactory _factory;
    public RobotStateMachine(RobotController robot, CoherenceSync _sync)
    {
        _factory = new RobotStateFactory(robot, _sync, this);
        CreateState();
    }
